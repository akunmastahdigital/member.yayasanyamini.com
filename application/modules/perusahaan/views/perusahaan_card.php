...
<form class="form-horizontal form-pbio" action="<?php echo base_url('perusahaan/perusahaan_submit')?>" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="div-input-tne">
                    ...
                    <input class="form-control input-tne <?php echo $msi['class']?>" 
                           ...
                           maxlength="<?php echo $msi['maxlength']?>"> 
                ...
                ?>
                  ...
                  <div class="row">
                    ...
                    <div class="div-input-tne">
                      ...
                      <input class="form-control input-tne <?php echo $msi['class']?>" data-val="<?php echo $tsi['nilai_'.$msi['tipe_data']]?>"
                      ...
                      <tr style="display: none;">
                        ...
                        ?>
                          ...
                          <td>
                            ...
                            class="form-control <?php echo $mpl['class']?>" placeholder="<?php echo $mpl['teks_judul'];?>" 
                          ...
                          $t_plural     = $this->M_core->get_tbl($msi['table_tujuan_p'], '*', $condition);
                            ...
                            ?>
                              ...
                              <td>
                                ...
                                class="form-control input-tbl <?php echo $mpl['class']?>" placeholder="<?php echo $mpl['teks_judul'];?>" 
                            ...
                            ?>
                              ...
                              <td>
                                ...
                                class="form-control input-tbl <?php echo $mpl['class']?>" 
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <button type="button" class="btn btn-primary add-tbl-row-rb">
  ...
  <div class="form-group">
    ...
    <div class="col-md-12">
      ...
      <button type="submit" name="submit" class="btn btn-danger btn-lg">
        ...
        <i class="fa fa-save"></i> Simpan Perusahaan
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('.form-pbio').find('.div-label-file').attr('class', 'div-label-file col-md-4');

    $('.form-pbio').find('.div-input-file').attr('class', 'div-input-file col-md-2');

    $('.form-pbio').find('.div-fln-file').attr('class', 'div-fln-file col-md-4');

    $('.form-pbio').find('.div-cttn-file').attr('class', 'div-cttn-file col-md-2');

    $('.form-pbio').find('.cttn-file').attr('disabled', false);



    //tne

    $('.form-pbio').find('.div-label-tne').attr('class', 'div-label-tne col-md-4');

    $('.form-pbio').find('.div-input-tne').attr('class', 'div-input-tne col-md-4');

    $('.form-pbio').find('.div-cttn-tne').attr('class', 'div-cttn-tne col-md-4');

    $('.form-pbio').find('.input-tne').attr('requred', false);

    $('.form-pbio').find('.cttn-tne').attr('requred', false);

    $('.form-pbio').find('.cttn-tne').attr('disabled', false);



    //select

    $('.form-pbio').find('.div-label-select').attr('class', 'div-label-select col-md-4');

    $('.form-pbio').find('.div-input-select').attr('class', 'div-input-select col-md-4');

    $('.form-pbio').find('.div-cttn-select').attr('class', 'div-cttn-select col-md-4');

    $('.form-pbio').find('.input-select').attr('requred', false);

    $('.form-pbio').find('.cttn-select').attr('requred', false);

    $('.form-pbio').find('.cttn-select').attr('disabled', false);
    ...
    $('.form-pbio').find('.div-cttn-tbl').attr('class', 'div-cttn-tbl col-md-12');

    $('.form-pbio').find('.input-tbl').attr('requred', false);

    $('.form-pbio').find('.cttn-tbl').attr('requred', false);

    $('.form-pbio').find('.cttn-tbl').attr('disabled', false);
  ...
  $(document).on('click', ".add-tbl-row-rb", function() {
    ...
    $('.currency]').prop("type", "text").attr('data-a-sep','.').attr('data-a-dec',',').autoNumeric('init', { mDec: '0' });
  ...
  function getApiPbio(e, url_ctrl) {
