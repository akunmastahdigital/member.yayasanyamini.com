      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card-box table-responsive">
            ...
            <h4 class="m-t-0 header-title"><b>List <?php echo $type;?></b> 
            ...
            <p class="text-muted font-13 m-b-30">
               Dibawah ini merupakan list <?php echo $type;?>
            </p>
...
<script type="text/javascript">
  ...
  // My Datatables
  var   urlDb1   = "<?php echo base_url('layanan_kontak/modul_layanan_show/'.$type)?>";
  var   totalClmn1;
  var   tbl1;
