         ...
         <div class="col-md-8 col-md-offset-2" >
          <div style="padding-top: 7%;"></div>
           <!-- <div class="alert alert-success" role="alert"> -->
               <h3 style="color: #000;"><strong>Untuk Mengakses Tutorial Klik Tombol Dibawah Ini
</strong></h3>
          <!-- </div> -->
          <br><h4>Masukkan Password : yaminikeren</h4><br>
          <a href="https://www.yayasanyamini.com/tutorial/" class="btn btn-lg btn-teal" target="_blank">Tutorial <i class="fa fa-arrow-right"></i></a>
