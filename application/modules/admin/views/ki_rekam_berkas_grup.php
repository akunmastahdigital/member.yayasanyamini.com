...
if ($page == 'accord') { ?>
  ...
  <div class="panel">
      <div class="panel-heading">
          ...
          <button type="button" data-action="edit" data-id="<?php echo $datag['id'];?>" class="action btn btn-xs waves-effect btn-info m-r-5 tooltip-hover pull-right" title="Edit Grup Berkas"> 
