      ...
      <div class="row">
          ...
          <div class="col-sm-9">
              <div class="card-box table-responsive">
                  ...
                  <button type="button" data-action="add" class="action btn btn-sm waves-effect btn-primary m-b-5 tooltip-hover pull-right submit btn-modal" title="Tambah Grup Syarat"> 
                    <i class="fa fa-plus"></i> Tambah Grup Syarat
                  </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Grup Syarat</h4>
            </div>
            <div class="modal-body">
                <input name="id_syarat_izin_grup" type="hidden">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" >×</button>
                <h4 class="modal-title">Data Syarat</h4>
            </div>
            <div class="modal-body">
                <input name="id_syarat_izin_s" type="hidden">
...
<script type="text/javascript">
  ...
  // My Datatables
  var   urlDb   = "<?php echo base_url('admin/show_ki_syarat_izin_grup')?>";
  var   totalClmn;
  var   table1;
  ...
  function get_datag() {
    ...
    $.ajax({
      url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+"get_dt_group",
      dataType: "json",
      data: 'jenis_izin='+jenis_izin,
      type: "POST",
      success: function(data) {
  ...
  function show_modal(data) {
    ...
    if (mode == "add") {
      ...
      $.ajax({
        url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+"detail",
        dataType: "json",
        data: "id_syarat_izin_grup="+data,
        type: "POST",
        success: function(data) {
          $('#form-field-grup').find('input[name="id_syarat_izin_grup"]').val(data.id_syarat_izin_grup);
      ...
      $.ajax({
        url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+"detail-child",
        dataType: "json",
        data: "id_syarat_izin_s="+data,
        type: "POST",
        success: function(data) {   
          $('#form-field-child').find('input[name="id_syarat_izin_s"]').val(data.id_syarat_izin_s);
          $('#form-field-child').find('input[name="id_syarat_izin_grup"]').val(data.id_syarat_izin_grup);
  ...
  var datatables_c = $.ajax({
      url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+"get_dt_child",
      dataType: "json",
      type: "POST"
    })
  ...
  $(document).on('click', ".action", function() {
        ...
        if (action == "show-group") {
          ...
          $.ajax({
            url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+mode,
            dataType: "json",
          ...
          $.ajax({
            ...
            var syarat_izin_s= $(this).attr('data-id');
            var nama        = $(this).closest("tr").find("td:eq(1)").text();

            $.ajax({
              url : "<?php echo base_url('admin/ki_syarat_izin_action')?>/"+action,
              dataType: "json",
              data: 'syarat_izin_s='+syarat_izin_s+'&status='+status,
              type: "POST",
              success: function(data) {
                if (data.status == 1) {
                  var text    = 'aktifkan';
