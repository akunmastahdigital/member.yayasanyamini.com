<!-- START LOOP M_GRUP -->
<form class="form-horizontal form-rb" action="<?php echo base_url('rekam_berkas/rekam_berkas_submit')?>" role="form" method="post" enctype="multipart/form-data">
<input type="hidden" name="id_permohonan" value="<?php echo $id_permohonan;?>">
<input type="hidden" name="id_jenis_izin" value="<?php echo $id_jenis_izin;?>">
...
<div class="div-grup">
  <div class="card-box table-responsive">
      ...
      <div class="row">
        ...
        $condition[]  = ['id_rekam_berkas_grup', $mgp['id_rekam_berkas_grup'], 'where'];
        $condition[]  = ['kd_rekam_berkas_s', 'asc', 'order_by'];
        $m_single     = $this->M_core->get_tbl('m_rekam_berkas_s', '*', $condition)->result_array(); 
        ?>
        ...
        $condition[]  = ['id_rekam_berkas_s', $msi['id_rekam_berkas_s'], 'where'];
        ...
        ?>
                ...
                <div class="row">
                  ...
                  <div class="div-input-file">
                    <input class="form-control input-file <?php echo $msi['class']?>" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>" type="<?php echo $msi['jenis_input'];?>" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>[]" value="" 
                  ...
                  <div class="div-fln-file">
                    <input class="form-control fln-file" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>_fln" type="text" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>_fln[]" value="" 
                           placeholder="filename"> 
                  </div>
                  <div class="div-cttn-file">
                    <input class="form-control cttn-file" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="" 
                           placeholder="catatan"> 
                  </div>
                </div>
              <?php
                ...
                ?>
                  <div class="row">
                    ...
                    <div class="div-input-file" style="display:block;">
                      <input class="form-control input-file <?php echo $msi['class']?>"
                             id="<?php echo $msi['nama_rekam_berkas'];?>" type="<?php echo $msi['jenis_input'];?>" 
                             name="<?php echo $msi['nama_rekam_berkas'];?>[]"
                             placeholder="<?php echo $msi['sub_teks_judul'];?>"
                             <?php echo $reqDt['attr'];?> <?php echo $msi['attribute']?>> 
                    </div>
                    <div class="div-fln-file">
                      <input class="form-control fln-file" 
                             id="<?php echo $msi['nama_rekam_berkas'];?>_fln" type="hidden" 
                             name="<?php echo $msi['nama_rekam_berkas'];?>_fln[]" value="<?php echo $tsi['file_name_asli']?>" 
                             placeholder="filename" style="display:none;"> 
                             <a onclick="showFileRb(this)" 
                    ...
                    <div class="div-cttn-file">
                      <input class="form-control cttn-file"
                             id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                             name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="<?php echo $tsi['catatan']?>" 
                             placeholder="catatan"> 
                    </div>
                  </div>
                <?php
              ...
              <div class="file-multiple">
                <div class="row">
                  ...
                  <div class="div-input-file">
                    <input class="form-control input-file <?php echo $msi['class']?>"
                           id="<?php echo $msi['nama_rekam_berkas'];?>" type="<?php echo $msi['jenis_input'];?>" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>[]" class="file-value" <?php echo $reqDt['attr'];?>
                           placeholder="<?php echo $msi['sub_teks_judul'];?>" <?php echo $msi['attribute']?>> 
                  </div>
                  <div class="div-fln-file">
                    <input class="form-control fln-file" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>_fln" type="text" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>_fln[]"
                           placeholder="filename"> 
                  </div>
                  <div class="div-cttn-file">
                    <input class="form-control cttn-file"
                           id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" 
                           placeholder="catatan"> 
                  </div>
                  <div class="col-md-2">
                    <div class="file-button">
                      <button type="button" class="btn btn-primary add-file-row-rb">
                ...
                <div class="row">
                  ...
                  <div class="div-input-tne">
                    <input class="form-control input-tne <?php echo $msi['class']?>" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>" type="<?php echo $msi['jenis_input'];?>" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>[]" value="" data-val=""
                           placeholder="<?php echo $msi['sub_teks_judul'];?>"
                           <?php echo $reqDt['attr'];?>
                           <?php echo $msi['attribute']?> maxlength="<?php echo $msi['maxlength']?>"> 
                  </div>
                  <div class="div-cttn-tne">
                    <input class="form-control cttn-tne" 
                           id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                           name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="" 
                           placeholder="catatan"> 
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="div-input-tne">
                      <input class="form-control input-tne <?php echo $msi['class']?>"
                             ...
                             <?php echo $reqDt['attr'];?> maxlength="<?php echo $msi['maxlength']?>"> 
                    </div>
                    <div class="div-cttn-tne">
                      <input class="form-control cttn-tne"
                             id="<?php echo $msi['nama_rekam_berkas'];?>" type="text" 
                             name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="<?php echo $tsi['catatan']?>" 
                             placeholder="catatan"> 
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="div-input-tne">
                    <input class="form-control input-tne text-value <?php echo $msi['class']?>"
                           ...
                           <?php echo $reqDt['attr'];?> 
                           <?php echo $msi['attribute']?>
                           placeholder="<?php echo $msi['sub_teks_judul'];?>" maxlength="<?php echo $msi['maxlength']?>"> 
                  </div>
                  <div class="div-cttn-tne">
                    <input class="form-control cttn-tne"
                           id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                  ...
                  <div class="col-md-2">
                    <div class="text-button">
                      <button type="button" class="btn btn-primary add-text-row-rb">
                        <i class="fa fa-plus"></i>
                      </button>
                    </div>
                  </div>
                ...
                <div class="text-multiple">
                  <div class="row">
                    ...
                    <div class="div-input-tne">
                      <input class="form-control input-tne <?php echo $msi['class']?>"
                             id="<?php echo $msi['nama_rekam_berkas'];?>" type="<?php echo $msi['jenis_input'];?>" 
                             name="<?php echo $msi['nama_rekam_berkas'];?>[]" class="text-value" 
                             data-val="<?php echo $tsi['nilai_'.$msi['tipe_data']]?>"
                             value="<?php echo $tsi['nilai_'.$msi['tipe_data']]?>"
                             <?php echo $reqDt['attr'];?> 
                             <?php echo $msi['attribute']?>
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="div-input-select">
                <select class="form-control input-select <?php echo $msi['class']?>"
                        name="<?php echo $msi['nama_rekam_berkas'];?>[]" 
                        id="<?php echo $msi['nama_rekam_berkas'];?>"
                  ...
                  $condition    = [];
                  $condition[]  = ['aktif', 1, 'where'];
                  $condition[]  = ['kd_rekam_berkas_p', 'asc', 'order_by'];
                  $condition[]  = ['id_rekam_berkas_s', $msi['id_rekam_berkas_s'], 'where'];
                  $m_plural     = $this->M_core->get_tbl('m_rekam_berkas_p', '*', $condition)->result_array();
                  ...
                  foreach($m_plural as $mpl) {
                    ...
                    $condition[]  = ['id_permohonan', $id_permohonan, 'where'];
                    $condition[]  = ['id_rekam_berkas_s', $msi['id_rekam_berkas_s'], 'where'];
                    $condition[]  = ['id_rekam_berkas_p', $mpl['id_rekam_berkas_p'], 'where'];
                    $condition[]  = ['index', 'asc', 'order_by'];
                  ...
                  ?>
                    <option value="<?php echo $mpl['id_rekam_berkas_p'];?>" <?php echo $selected;?>><?php echo $mpl['teks_judul'];?></option>
                  <?php 
                  } 
                  ?>
                </select>
              ...
              <div class="div-cttn-select">
                <input class="form-control cttn-select"
                       id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                       name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="<?php echo $cttn?>"
                       placeholder="catatan"> 
              </div>
            </div>
          <?php
          ...
          if(($msi['jenis_input'] == 'select') && ($msi['special'] == 1)) {
            ...
            $condition[]  = ['id_permohonan', $id_permohonan, 'where'];
            $condition[]  = ['id_rekam_berkas_s', $msi['id_rekam_berkas_s'], 'where'];
            $t_plural     = $this->M_core->get_tbl('t_rekam_berkas_p', '*', $condition);
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="div-input-select">
                <select class="form-control input-select <?php echo $msi['class']?>"
                        name="<?php echo $msi['nama_rekam_berkas'];?>_num[]" 
                        id="<?php echo $msi['nama_rekam_berkas'];?>"
                        <?php echo $reqDt['attr'];?> <?php echo $msi['attribute']?>
                ...
                <input type="hidden" name="<?php echo $msi['nama_rekam_berkas'];?>_string[]">
              </div>
              <div class="div-cttn-select">
                <input class="form-control cttn-select"
                       id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
          ...
          ?>
            <div class="row" style="margin-bottom:15px;">
              ...
              <div class="div-input-tbl" style="overflow-x: auto;">
                <table class="table table-bordered table-hover">
                  ...
                  <tr>  
                    ...
                    $condition[]  = ['kd_rekam_berkas_p', 'asc', 'order_by'];
                    $condition[]  = ['id_rekam_berkas_s', $msi['id_rekam_berkas_s'], 'where'];
                    $m_plural     = $this->M_core->get_tbl('m_rekam_berkas_p', '*', $condition);

                    $idmpl = [];
                    foreach($m_plural->result_array() as $mpl) {
                      $idmpl[] = $mpl['id_rekam_berkas_p'];
                    ?>
                      <th name="<?php echo $mpl['id_rekam_berkas_p'];?>" class="text-center"><?php echo $mpl['teks_judul'];?></th>
                    <?php 
                    } 
                    ?>
                  ...
                  <tbody>
                    <?php
                    $t_plural_group = $this->M_core->t_plural_group_1($id_permohonan, 'rekam_berkas');
                    
                    $idtpl = [];
                    foreach($t_plural_group->result_array() as $tpg) {
                      $idtpl[] = $tpg['id_rekam_berkas_p'];
                    }
                      ...
                      <tr style="display: none;">
                        ...
                        ?>
                          <td>
                            ...
                            name="<?php echo $mpl['nama_rekam_berkas_p'];?>[]" disabled
                            class="form-control <?php echo $mpl['class']?> datepicker" placeholder="<?php echo $mpl['teks_judul'];?>" 
                            maxlength="<?php echo $mpl['maxlength']?>">
                          </td>
                        <?php 
                        } 
                        ?>
                        <td class="text-center">
                          <button type="button" class="btn btn-danger del-tbl-row-rb">
                    ...
                    <?php  
                      ...
                      $t_plural_group_index = $this->M_core->t_plural_group_index_1($id_permohonan, 'rekam_berkas');
                      ...
                      ?>
                        <tr>
                          ...
                          $t_plural     = $this->M_core->get_tbl($msi['table_tujuan_p'], '*', $condition);
                            ...
                            ?>
                              <td>
                                ...
                                name="<?php echo $mpl['nama_rekam_berkas_p'];?>[]" 
                                class="form-control input-tbl <?php echo $mpl['class']?> datepicker" placeholder="<?php echo $mpl['teks_judul'];?>" 
                                maxlength="<?php echo $mpl['maxlength']?>">
                              </td>
                            <?php
                            } else {
                            ...
                            ?>
                              <td>
                                ...
                                name="<?php echo $mpl['nama_rekam_berkas_p'];?>[]"
                                class="form-control input-tbl <?php echo $mpl['class']?> datepicker" 
                          ...
                          <td class="text-center">
                            ...
                            class="btn btn-danger del-tbl-row-rb">
                              <i class="fa fa-minus"></i>
                            </button>
                          </td>
                        </tr>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="text-center">
                        <button type="button" class="btn btn-primary add-tbl-row-rb" onclick="checkDate()">
                          <i class="fa fa-plus"></i>
                        </button>
                      </td>
                    </tr>
              ...
              <div class="div-cttn-tbl">
                <input class="form-control cttn-tbl"
                       id="<?php echo $msi['nama_rekam_berkas'];?>_cttn" type="text" 
                       name="<?php echo $msi['nama_rekam_berkas'];?>_cttn[]" value="<?php echo $cttn?>"
                       placeholder="catatan"> 
              </div>
...
<div class="form-group">
  <div class="col-md-12">
    <button type="submit" name="submit" class="btn btn-danger btn-lg">
      <i class="fa fa-save"></i> Simpan Rekam Berkas
    </button>
  </div>
</div>
<?php } ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    //btn
    $('.form-rb').find('.div-btn-submit').css('display', 'none');     
    $('.form-rb').find('.btn-submit').css('disabled', true);

    //grup
    $('.form-rb').find('.div-grup').attr('class', 'div-grup col-md-12');

    //file
    $('.form-rb').find('.div-label-file').attr('class', 'div-label-file col-md-4');
    $('.form-rb').find('.div-input-file').attr('class', 'div-input-file col-md-2');
    $('.form-rb').find('.div-fln-file').attr('class', 'div-fln-file col-md-4');
    $('.form-rb').find('.div-cttn-file').attr('class', 'div-cttn-file col-md-2');
    $('.form-rb').find('.cttn-file').attr('disabled', false);

    //tne
    $('.form-rb').find('.div-label-tne').attr('class', 'div-label-tne col-md-4');
    $('.form-rb').find('.div-input-tne').attr('class', 'div-input-tne col-md-4');
    $('.form-rb').find('.div-cttn-tne').attr('class', 'div-cttn-tne col-md-4');
    $('.form-rb').find('.input-tne').attr('requred', false);
    $('.form-rb').find('.cttn-tne').attr('requred', false);
    $('.form-rb').find('.cttn-tne').attr('disabled', false);

    //select
    $('.form-rb').find('.div-label-select').attr('class', 'div-label-select col-md-4');
    $('.form-rb').find('.div-input-select').attr('class', 'div-input-select col-md-4');
    $('.form-rb').find('.div-cttn-select').attr('class', 'div-cttn-select col-md-4');
    $('.form-rb').find('.input-select').attr('requred', false);
    $('.form-rb').find('.cttn-select').attr('requred', false);
    $('.form-rb').find('.cttn-select').attr('disabled', false);
    
    //tbl
    $('.form-rb').find('.div-label-tbl').attr('class', 'div-label-tbl col-md-12');
    $('.form-rb').find('.div-input-tbl').attr('class', 'div-input-tbl col-md-12');
    $('.form-rb').find('.div-cttn-tbl').attr('class', 'div-cttn-tbl col-md-12');
    $('.form-rb').find('.input-tbl').attr('requred', false);
    $('.form-rb').find('.cttn-tbl').attr('requred', false);
    $('.form-rb').find('.cttn-tbl').attr('disabled', false);
  })

  //APPEND FILE 
  $(document).on('click', ".add-file-row-rb", function() {
    var content   = $(this).closest('.row').clone();
    
    var button  = '<button type="button" class="btn btn-danger del-file-row-rb">' +
                    '<i class="fa fa-minus"></i>' +
                  '</button>';
  ...
  $(document).on('click', ".del-file-row-rb", function() {
    $(this).closest('.row').remove();
  })

  //SHOW FILE
  function showFileRb(e) {
    var id    = $(e).data('id');
    var index = $(e).data('index');
    var data  = {"id": id, "index": index};
    $.ajax({
        url : "<?php echo base_url('permohonan_izin/show_file/rekam_berkas')?>",
        dataType: "html",
        data: data,
        type: "POST",
  ...
  //APPEND TEXT 
  $(document).on('click', ".add-text-row-rb", function() {
    var content   = $(this).closest('.row').clone();
    
    var button  = '<button type="button" class="btn btn-danger del-text-row-rb">' +
                    '<i class="fa fa-minus"></i>' +
                  '</button>';
  ...
  $(document).on('click', ".del-text-row-rb", function() {
    $(this).closest('.row').remove();
  })


  //APPEND TBL 
  $(document).on('click', ".add-tbl-row-rb", function() {
  ...
  $(document).on('click', ".del-tbl-row-rb", function() {
    $(this).closest('tr').remove();
  })


  //TEXT SPECIAL
  function getApiRb(e, url_ctrl) {
    var x = $(e).val();
    $.ajax({
      type: "POST",
