      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="card-box table-responsive">
              ...
              <h4 class="m-t-0 header-title">Status izin</b> 
              </h4>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <select name="status" class="form-control" required>
                      <option value="1">- Masih di meja -</option>
                      <option value="2" selected="selected">- Sudah di approve -</option>
                    </select>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  function filter() {
    ...
    //btn export
    var url_pdf = '<?php echo base_url('laporan/laporan_dcs_export/pdf');?>'+'?status='+status+
    '&id_nama_izin='+id_nama_izin+'&id_jenis_izin='+id_jenis_izin;
    var url_excel = '<?php echo base_url('laporan/laporan_dcs_export/excel');?>'+'?status='+status+
    '&id_nama_izin='+id_nama_izin+'&id_jenis_izin='+id_jenis_izin;
    $('.btn_pdf').attr('href', url_pdf);
    $('.btn_excel').attr('href', url_excel);

    //get total
    var url_control = base_url+"laporan/laporan_dcs_total/"+1;
    $.ajax({
      type : "POST",
      url : url_control,
      data : {status : status,
  ...
  // My Datatables
  var   urlDb1   = "<?php echo base_url('laporan/laporan_dcs_show/')?>";
  var   totalClmn1;
  var   tbl1;
