          ...
          <div class="card-box table-responsive">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group" style="margin-top: 100px;">
                  <div class="col-md-12">
                     <button class="btn btn-primary w-sm waves-effect m-t-20 waves-light pull-right" onclick="search()"><i class="fa fa-filter"></i> Filter</button>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card-box table-responsive">
            ...
            <h4 class="m-t-0 header-title"><b>List Perizinan</b> 
            ...
            <p class="text-muted font-13 m-b-30">
               Dibawah ini merupakan list perizinan 
            </p>
...
<script type="text/javascript">
  ...
  function search() {
    ...
    //btn export
    var url_pdf = '<?php echo base_url('laporan/laporan_export_perizin/pdf');?>'+
    '?id_nama_izin='+id_nama_izin+'&id_jenis_izin='+id_jenis_izin+'&date_start='+date_start+'&date_end='+date_end;
    var url_excel = '<?php echo base_url('laporan/laporan_export_perizin/excel');?>'+
    '?id_nama_izin='+id_nama_izin+'&id_jenis_izin='+id_jenis_izin+'&date_start='+date_start+'&date_end='+date_end;
    $('.btn_pdf').attr('href', url_pdf);
    $('.btn_excel').attr('href', url_excel);

    //get total
    var url_control = base_url+"laporan/laporan_total_perizin/"+1;
    $.ajax({
      type : "POST",
      url : url_control,
  ...
  // My Datatables
  var   urlDb1   = "<?php echo base_url('laporan/laporan_show2')?>";
  var   totalClmn1;
  var   tbl1;
