...
<table style="width: 530px; height: 10px; margin-left: auto; margin-right: auto;">
	<tbody>
		<tr style="line-height: 18px;">
			<td class="" style="font-size: 16px; text-align:center; width: 100%;" colspan="7">Laporan Retribusi <?php echo $izin;?></td>
		</tr>
		<tr style="line-height: 18px;">
			<td class="" style="font-size: 12px; text-align:center; width: 100%;" colspan="7">
                    ...
                    <?php 
                    if($status_byr == 1) {
                        $status = 'Yang Sudah Bayar';
                    } else if($status_byr == 2) {
                        $status = 'Yang Belum Bayar';
                    } else {
                        $status = '';
                    }
                    ?>
...
<table style="width: 530px; height: 10px; margin-left: auto; margin-right: auto;" border="1">
	<thead>
		<tr style="line-height: 18px;">
			...
			<th class="l t r b" style="width:15%"><b>No SKRD</b></th>
			<th class="l t r b" style="width:15%"><b>Tgl Terbit SKRD</b></th>
			<th class="l t r b" style="width:15%"><b>Status Bayar</b></th>
			<th class="l t r b" style="width:15%"><b>Kode Bayar</b></th>
			<th class="l t r b" style="width:15%"><b>Tgl Bayar</b></th>
			<th class="l t r b" style="width:15%"><b>Nominal</b></th>
		</tr>
	</thead>
	<tbody>
		...
		<tr style="line-height: 18px;">
            ...
            <td class="l t r b" style="width:15%"><?php echo $gtl['tgl_terbit_skrd'];?></td>
            <?php 
            	if($gtl['id_histori_pembayaran'] != null) { 
            		$status_byr = 'Sudah';
            	} else {
            		$status_byr = 'Belum';
            	}
            ?>
            <td class="l t r b" style="width:15%"><?php echo $status_byr;?></td>

            <td class="l t r b" style="width:15%"><?php echo $gtl['kode_bayar'];?></td>
            <td class="l t r b" style="width:15%"><?php echo $gtl['tgl_bayar'];?></td>
            <td class="l t r b" style="width:15%"><?php echo number_format($gtl['nominal']);?></td>
		</tr>
		<?php $no++;} ?>
	</tbody>
</table>
