...
<table style="width: 530px; height: 10px;margin-left: auto; margin-right: auto;">
	<tbody>
		...
		<tr style="line-height: 15px;">
			...
			<td style="width: 50%;" style="text-align: justify;" colspan="3"><?php echo $approver['jabatan'];?></td>
		</tr>
		...
		<tr style="line-height: 12px;">
			...
			<td style="width: 10%;" class=""></td>
			<td style="width: 50%;text-align: center;font-weight: bold;" colspan="3"><u><?php echo $approver['name'];?></u></td>
		</tr>
		<tr style="line-height: 12px;">
			<td style="width: 10%;" class=""></td>
			<td style="width: 10%;" class=""></td>			
			<td style="width: 50%;text-align: center;" colspan="2"><?php echo $approver['pembina'];?></td>
		</tr>
		<tr style="line-height: 20px;">
			<td style="width: 10%;" class=""></td>
			<td style="width: 10%;" class=""></td>			
			<td style="width: 50%;text-align: center;" colspan="3">NIP. <?php echo $approver['nip'];?></td>
		</tr>
	</tbody>
</table>