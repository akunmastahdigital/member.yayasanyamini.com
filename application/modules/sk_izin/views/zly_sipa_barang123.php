...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	...
	<td  style="text-align:left; width:22%; font-size:0.6em;"><!-- Nama Pemilik / Perusahaan --></td>
...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	<tbody>
	<tr style="line-height:20px">
	<td  style="text-align:left; width:22%; font-size:0.6em;"><!-- Alamat Pemilik --></td>
	<td style="width: 3%;font-size:0.6em;" ><!-- : --></td>
...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	<tbody>
	<tr style="line-height:20px">
	<td  style="text-align:left; width:22%; font-size:0.6em;"><!-- Masa Berlaku --></td>
	<td style="width: 3%;font-size:0.6em;" ><!-- : --></td>
...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	...
	<td  style="text-align:center; width:20%;" ><!-- No. Uji --></td>
	<td  style="text-align:center; width:32.5%;" ><!-- Jenis Kendaraan --></td>
	<td style="text-align:center; width:32.5%;" ><!-- Kode Operasi --></td>
	</tr>
	<tr style=" line-height:22px">
	<td style="text-align:center; width:15%;  font-size:0.7em;">#idx6#</td>
	<td style="text-align:center; width:20%; font-size:0.7em;" >#idx7#</td>
	<td style="text-align:center; width:32.5%; font-size:0.7em;" >#idx8#</td>
	<td style="text-align:center; width:32.5%; font-size:0.7em;" >#idx9#</td>
	</tr>
	</tbody>
</table>
...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	...
	<td style="width:34%;"><span style="text-align:center;font-size:1.2em !important;">#idx10#</span></td>
	</tr>
	<tr style="font-size:0.5em;">
	...
	<td style="text-align:center; width:15%;">
		...
		<td style="width:32%;text-align:left;line-height:6px;font-weight:bold;font-size:1.0em;"rowspan="5"><?php echo $approver['jabatan1'];?><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $approver['jabatan2'];?><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $approver['jabatan3'];?><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="berkas/core/images/tanda_tangan/<?php echo $approver['stempel'];?>" width="40px"></td>
	</tr>
	<tr style="font-size:0.5em;">
	...
	<tr>
		...
		<td style=" width:37%;font-size:0.5em;font-weight:bold;text-align:center;"><span style=""><?php echo $approver['name'];?></span><br>NIP. <?php echo $approver['nip'];?></td>
	</tr>
	</tbody>
</table>