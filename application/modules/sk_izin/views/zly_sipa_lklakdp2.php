...
<table style="width: 100%; margin-left: auto; margin-right: auto;">
	...
	<td style="text-align:center; width:15%;">
		...
		<td style="width:32%;text-align:center;line-height:6px;font-weight:bold;font-size:1.0em;"rowspan="5"><?php echo $approver['jabatan1'] $approver['jabatan'];?><br><img src="berkas/core/images/tanda_tangan/<?php echo $approver['stempel'];?>" width="63px"></td>
	</tr>
	<tr style="font-size:0.5em;">
