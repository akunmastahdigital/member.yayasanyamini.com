...
<table style="width: 530px; height: 10px;margin-left: auto; margin-right: auto;">
	<tbody>
		...
		<?php if ($status_perusahaan == 'Cabang') {?>
		<tr style="line-height: 22px;">
...
<table style="width: 530px; height: 10px;margin-left: auto; margin-right: auto;">
	<tbody>
		...
		<tr style="line-height: 15px;">
			...
			<td style="width: 50%;" style="text-align: left;" colspan="3"><?php echo $approver['jabatan1'];?></td>
		</tr>
		<tr style="line-height: 15px;">
			<td style="width: 35%;"></td>
			<td style="width: 50%;" style="text-align: left;" colspan="3"><?php echo $approver['jabatan'];?>
			<span style="text-align: center;"><br>SELAKU</span><br>KEPALA KANTOR PENDAFTARAN PERUSAHAAN</td>
		</tr>
		...
		<tr style="line-height: 2px;">
			...
			<td style="width: 80%;" colspan="4"><img src="berkas/core/images/tanda_tangan/<?php echo $approver['stempel'];?>" width="150px"></td>
		</tr>
		<tr style="line-height: 12px;">
			...
			<td style="width: 50%;text-align: left;font-weight: bold;" colspan="3"><u><?php echo $approver['name'];?></u></td>
		</tr>
		<tr style="line-height: 12px;">
			<td style="width: 15%;" class=""></td>
			<td style="width: 10%;" class=""></td>			
			<td style="width: 50%;text-align: left;" colspan="2"><?php echo $approver['pembina'];?></td>
		</tr>
		<tr style="line-height: 20px;">
			<td style="width: 15%;" class=""></td>
			<td style="width: 10%;" class=""></td>			
			<td style="width: 50%;text-align: left;" colspan="3">NIP. <?php echo $approver['nip'];?></td>
		</tr>
	</tbody>
</table>